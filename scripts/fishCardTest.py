...
def FishCardPanel_test(bp: BasePage):
    ...
    # bp.set_item_count_list(target_count_list=[1234567890, 100000], item_tpid_list=["100000", "100200"])
    # r1 = random.randint(8, 22)
    # r2 = random.randint(23, 37)
    # bp.cmd_list([f"add 10 1000{str(r1).zfill(3)} 1", f"add 10 1000{str(r2).zfill(3)} 500000"])
