...
if __name__ == "__main__":
    ...
    # bp.sleep(1)
    # bp.cmd("add 9 900021 50")
    # bp.sleep(1)
    # bp.cmd("add 9 900012 50")
    # bp.sleep(1)
    # bp.cmd("add 9 900022 50")
    # bp.sleep(1)
    # bp.cmd("add 9 900013 50")
    # bp.sleep(1)
    # bp.cmd("add 9 900023 50")
    # bp.sleep(1)
    # bp.cmd("add 9 900014 50")
    # bp.sleep(1)
    # bp.cmd("add 9 900024 50")
    # bp.sleep(1)
    # specify_level(bp, tpId=500011, target_level=60)
    # bp.sleep(1)
    # specify_level(bp, tpId=500021, target_level=60)
    # bp.sleep(1)
    # specify_level(bp, tpId=500012, target_level=60)
    # bp.sleep(1)
    # specify_level(bp, tpId=500022, target_level=60)
    # bp.sleep(1)
    # specify_level(bp, tpId=500013, target_level=60)
    # bp.sleep(1)
    # specify_level(bp, tpId=500023, target_level=60)
    # bp.sleep(1)
    # specify_level(bp, tpId=500014, target_level=60)
    # bp.sleep(1)
    # specify_level(bp, tpId=500024, target_level=60)
    # bp.sleep(1)
    # specify_level(bp, target_level=80, tpId=500028)
    # one_star(bp, tpId=500011)
    # bp.sleep(1)
    # one_star(bp, tpId=500012)
    # bp.sleep(1)
    # one_star(bp, tpId=500012)
    # bp.sleep(1)
    # one_star(bp, tpId=500022)
    # bp.sleep(1)
    # one_star(bp, tpId=500013)
    # bp.sleep(1)
    # one_star(bp, tpId=500023)
    # bp.sleep(1)
    # one_star(bp, tpId=500014)
    # bp.sleep(1)
    # one_star(bp, tpId=500023)
    # bp.sleep(1)
