...
def main(bp: BasePage):
    ...
    BattlePreparePanel.panel_pve_prepare.click_btn_menu(bp)
    bp.sleep(1)
    BattlePreparePanel.panel_pve_prepare.panel_main_sidebar.click_btn_mail(bp)
    ...
    BattlePreparePanel.panel_pve_prepare.click_btn_menu(bp)
    bp.sleep(1)
    BattlePreparePanel.panel_pve_prepare.panel_main_sidebar.click_btn_announcement(bp)
    ...
    BattlePreparePanel.panel_pve_prepare.click_btn_menu(bp)
    bp.sleep(1)
    BattlePreparePanel.panel_pve_prepare.panel_main_sidebar.click_btn_avatar(bp)
