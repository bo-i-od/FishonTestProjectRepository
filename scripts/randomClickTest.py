...
def registry_panels():
    ...
    panels.register_panel(name="AquariumBuildMainPanel", panel=AquariumBuildMainPanel)
    panels.register_panel(name="AquariumBuildPanel", panel=AquariumBuildPanel)
    panels.register_panel(name="AquariumFishNewPanel", panel=AquariumFishNewPanel)
    panels.register_panel(name="AquariumFishPanel", panel=AquariumFishPanel)
    panels.register_panel(name="AquariumPanel", panel=AquariumPanel)
