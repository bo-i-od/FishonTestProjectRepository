...
class ElementsData:
    class Common:
        class ChampointshipResultPopup:
            reward_icon_list = {"locator": "UICanvas>Default>ChampointshipResultPopup>panel>rewards>>icon"}
            reward_quantity_list = {"locator": "UICanvas>Default>ChampointshipResultPopup>panel>rewards>>value"}
        #  通用
        # btn_close_tournament = {"locator": "UICanvas", "locator1": "ChampointshipResultPopup", "locator2": "btn_close",
        #                         "locator3": "btn_normal",
        #                         "position": (0.5, 0.5)}
        # btn_confirm_reconnect = {"locator": "UICanvas", "locator1": "MessageBoxPanel", "locator2": "btn_confirm",
        #                          "locator3": "btn_normal",
        #                          "position": (0.5, 0.5)}
    class Login:
        InputField_UserName = {"locator": "UICanvas>Default>LoginPanel>panel_internal>InputField_UserName>Text"}
    ...
    class Home:
        ...
        btn_roulette = {"locator": "UICanvas>Default>HomePanel>panel>btn_roulette>img"}
    ...
    # locator_btn_unfold = ("btn_unfold")
    # locator_btn_fold = ("btn_fold")
    #  设置
    class PlayerSetting:
        ...
        btn_close_profile = {"locator": "UICanvas>Default>PlayerSettingPanel>Panel_Popups_Edit>Panel>btn_close>img"}
    ...
    class Mail:
        ...
        system_tab = {"locator": "UICanvas>Default>MailPanel>MailList>tab_switch>tab_1>bg"}
        common_tab = {"locator": "UICanvas>Default>MailPanel>MailList>tab_switch>tab_2>bg"}
        img_unread_gift_list = {"locator": "UICanvas>Default>MailPanel>MailList>MailArea>Scroll View>Viewport>Content>>img_unread_gift"}
        reward_icon_list = {"locator": "UICanvas>Default>MailPanel>MailDetail>panel>Content>Scroll View>Viewport>Content>rewards>rewards>>icon"}
        reward_quantity_list = {"locator": "UICanvas>Default>MailPanel>MailDetail>panel>Content>Scroll View>Viewport>Content>rewards>rewards>>quantity>value"}
        claim = {"locator": "UICanvas>Default>MailPanel>MailDetail>panel>Content>Scroll View>Viewport>Content>rewards>btn_claim>btn_normal"}
    ...
    class TreasureChestMerchant:
        ...
        ResourceBar = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>top_res>ResourceBar"}
        text_100100 = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>top_res>ResourceBar>100100>value"}
        # btn_add
        btn_add_100100 = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>top_res>ResourceBar>100100>btn_add>btn_normal"}
        btn_refresh_text = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>treasurechest_merchant_text>btn>text"}
        btn_refresh_value = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>treasurechest_merchant_text>btn>value"}
        times_refresh = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>treasurechest_merchant_text>bg>times>text"}
        quantity_list = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>items>>quantity>value"}
        btn_buy_list = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>items>>>btn_buy>text"}
        btn_disabled_list = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>items>>btn_disabled>text"}
        off_list = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>items>>value_bg>number"}
        box_list = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>items>>box"}
        item_list = {"locator": "UICanvas>Default>TreasureChestMerchantPanel>Panel>items>"}
    ...
    class BattlePrepare:
        ...
        class pve_prepare:
            btn_cast = {"locator": "UICanvas>Default>BattlePreparePanel>panel_pve_prepare>panel_pve>btn_cast>btn_normal"}
            ...
            value_100500 = {"locator": "UICanvas>Default>BattlePreparePanel>panel_pve_prepare>top_res>ResourceBar>100500>value"}
    ...
    class Result:
        ...
        class pve_result:
            ...
            btn_claim = {
                "locator": "UICanvas>Default>ResultPanel>panel_pve_result>panel_result>btns>btn_claim>btn_normal"}
            btn_gohome = {
    ...
    class Task:
        ...
        time_daily = {"locator": "UICanvas>Default>TaskPanel>panel>content_daily>banner>time>text"}
        time_weekly_ = {"locator": "UICanvas>Default>TaskPanel>panel>content_weekly>banner>time>text"}
        time_month = {"locator": "UICanvas>Default>TaskPanel>panel>content_month>banner>time>text"}
        time_list = {"locator": "UICanvas>Default>TaskPanel>panel>>banner>time>text"}
        # 对照数量
        task_list = {"locator": "UICanvas>Default>TaskPanel>panel>>ranking_list>view_port>content"}
        btn_completed_list = {"locator": "UICanvas>Default>TaskPanel>panel>>ranking_list>view_port>content>>btn_completed>btn_normal"}
        btn_undone_list = {"locator": "UICanvas>Default>TaskPanel>panel>>ranking_list>view_port>content>>btn_undone>btn_normal"}
        ...
        item1_quantity_list = {"locator": "UICanvas>Default>TaskPanel>panel>>ranking_list>view_port>content>>item1>item_model_new>quantity>value"}
        item1_icon_list = {"locator": "UICanvas>Default>TaskPanel>panel>>ranking_list>view_port>content>>item1>item_model_new>icon"}
        item2_quantity_list = {"locator": "UICanvas>Default>TaskPanel>panel>>ranking_list>view_port>content>>item2>item_model_new>quantity>value"}
        item2_icon_list = {"locator": "UICanvas>Default>TaskPanel>panel>>ranking_list>view_port>content>>item2>item_model_new>icon"}
        progress_value = {"locator": "UICanvas>Default>TaskPanel>panel>>banner>progress>item>progress_bg"}
        award_list = {"locator": "UICanvas>Default>TaskPanel>panel>>banner>progress>item>award"}
        ...
        award_detail = {"locator": "UICanvas>Default>TaskPanel>panel>>banner>progress>item>progress_bg>>detialObj>detial"}
        award_quantity_list = {"locator": "UICanvas>Default>TaskPanel>panel>>banner>progress>item>progress_bg>>detialObj>detial>>quantity>value"}
        award_icon_list = {"locator": "UICanvas>Default>TaskPanel>panel>>banner>progress>item>progress_bg>>detialObj>detial>>icon"}
    ...
    class ChampoinshipTournaments:
        ...
        tab_current_tournament = {"locator": "UICanvas>Important>ChampoinshipTournamentsPanel>panel_sidebar>panel>tab>tab_1>text"}
        tab_all_tournaments = {"locator": "UICanvas>Important>ChampoinshipTournamentsPanel>panel_sidebar>panel>tab>tab_2>text"}
    ...
    class Rewards:
        ...
        tap_to_continue = {"locator": "UICanvas>Default>RewardsPanel>panel>text"}
    ...
    class BuyEnergy:
        ...
        cash_value = {"locator": "UICanvas>Default>BuyEnergyPanel>top_res>ResourceBar>100100>value"}
        energy_value = {"locator": "UICanvas>Default>BuyEnergyPanel>top_res>ResourceBar>100500>value"}
    ...
    class RechargeStore:
        RechargeStorePanel = {"locator": "UICanvas>Default>RechargeStorePanel"}
        btn_close = {"locator":"UICanvas>Default>RechargeStorePanel>Panel>btn_close>img"}
    ...
    class Roulette:
        ...
        btn_spin = {"locator": "UICanvas>Default>RoulettePanel>Panel>panel_right>btn_spin>btn_normal"}
        cost = {"locator": "UICanvas>Default>RoulettePanel>Panel>panel_right>btn_spin>cost>value"}
        ticket_quantity = {"locator": "UICanvas>Default>RoulettePanel>Panel>panel_right>quantity>Text"}
