...
class JumpData:
    ...
    panel_close_dict = {
        ...
        "BattlePreparePanel": [ElementsData.BattlePrepare.btn_cancel, ElementsData.BattlePrepare.btn_close],
        ...
        "ClubRedEnvelopePanel": [ElementsData.ClubRedEnvelope.btn_close],
