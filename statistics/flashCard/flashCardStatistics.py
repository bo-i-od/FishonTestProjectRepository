...
for index,i in enumerate(cast_log):
    ...
    if pid>0 and pid not in [60010,20040,20041]:
        ...
        if 1:  # 注释代表仅看鱼(300000<f_fish_id<320000) or (390000<f_fish_id<391000):
            ...
            if f_id:
                ...
                if flash_card[f_fish_id]['flash_card_num']==0:
                    ...
                    flash_card[f_fish_id]['first_collect_energy_cost']=cast_log[index][DebugInfo]["energyCost"]
                flash_card[f_fish_id]['flash_card_num'] += f_num
                flash_card[f_fish_id]['flash_card_times']+=1
    if (index>0 and index%per_print_cast==0) :
