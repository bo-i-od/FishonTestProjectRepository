...
class RechargeEndlessAddOnPanel(BasePage):
    def is_panel_active(self):
        return self.exist(element_data=ElementsData.RechargeEndlessAddOnPanel.RechargeEndlessAddOnPanel)

    def click_btn_close(self):
        self.click_element(element_data=ElementsData.RechargeEndlessAddOnPanel.btn_close, ignore_set={"CommonRewardsTipsPanel", "RechargeEndlessAddOnPanel"})

    def get_item_id_list(self):
        return self.get_object_id_list(element_data=ElementsData.RechargeEndlessAddOnPanel.item_model_list)

    def get_item_info_list(self):
        item_id_list = RechargeEndlessAddOnPanel.get_item_id_list(self)
    ...
    def get_btn_buy_position_list(self):
        return self.get_position_list(element_data=ElementsData.RechargeEndlessAddOnPanel.btn_buy_list)

    def get_btn_status(self):
        btn_buy_position_list = RechargeEndlessAddOnPanel.get_btn_buy_position_list(self)
        unlocked_index = 0
        locked_list = []
        cur = 0
    ...
    def click_icon_main(self, index=-1):
        self.click_object_of_plural_objects(element_data=ElementsData.RechargeEndlessAddOnPanel.icon_main_list, index=index, ignore_set={"CommonRewardsTipsPanel", "RechargeEndlessAddOnPanel"})

    def click_icon_sub(self, index=-1):
        self.click_object_of_plural_objects(element_data=ElementsData.RechargeEndlessAddOnPanel.icon_sub_list, index=index, ignore_set={"CommonRewardsTipsPanel", "RechargeEndlessAddOnPanel"})

    def click_btn_buy(self, index=-1):
        self.click_object_of_plural_objects(element_data=ElementsData.RechargeEndlessAddOnPanel.btn_buy_list, index=index, ignore_set={"CommonRewardsTipsPanel", "RechargeEndlessAddOnPanel"})


    operation_pool = [
        {"element_data": ElementsData.RechargeEndlessAddOnPanel.icon_main_list, "func": click_icon_main, "weight": 1},
        {"element_data": ElementsData.RechargeEndlessAddOnPanel.icon_sub_list, "func": click_icon_sub, "weight": 1},
        {"element_data": ElementsData.RechargeEndlessAddOnPanel.btn_buy_list, "func": click_btn_buy, "weight": 1},
        {"element_data": ElementsData.RechargeEndlessAddOnPanel.btn_close, "func": click_btn_close, "weight": 1},
    ]


if __name__ == "__main__":
    bp = BasePage()
    RechargeEndlessAddOnPanel.click_icon_main(bp)
    RechargeEndlessAddOnPanel.click_icon_sub(bp)
    bp.connect_close()