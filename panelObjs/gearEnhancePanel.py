...
class GearEnhancePanel(BasePage):
    ...
    def get_cost(self):
        cost_numerator = self.get_text(element_data=ElementsData.GearEnhance.cost_numerator)
        cost_numerator = int(cost_numerator)
        cost_denominator = self.get_text(element_data=ElementsData.GearEnhance.cost_denominator)
        cost_denominator = int(cost_denominator.split('/')[1])
        return cost_numerator, cost_denominator
