...
class PlayerInfoPanel(BasePage):
    ...
    def switch_tab(self, index):
        position_list = self.get_position_list(element_data=ElementsData.PlayerInfoPanel.tab_list)
    ...
    def click_btn_logout(self):
        self.click_element(element_data=ElementsData.PlayerInfoPanel.btn_logout)
    ...
    def click_btn_save_pay(self):
        self.click_element(element_data=ElementsData.PlayerInfoPanel.btn_save_pay)
