...
class DivisionLeaderboardPanel(BasePage):
    ...
    class panel_myleague(BasePage):
        ...
        def click_btn_playercard_self(self):
            self.click_element(element_data=ElementsData.DivisionLeaderboardPanel.panel_myleague.btn_playercard_self)
        ...
        def click_item_self(self, index=-1):
            self.click_object_of_plural_objects(element_data=ElementsData.DivisionLeaderboardPanel.panel_myleague.item_self, index=index)
    ...
    class panel_arena(BasePage):
        ...
        def click_btn_playercard_self(self):
            self.click_element(element_data=ElementsData.DivisionLeaderboardPanel.panel_arena.btn_playercard_self)
        ...
        def click_item_self(self, index=-1):
            self.click_object_of_plural_objects(element_data=ElementsData.DivisionLeaderboardPanel.panel_arena.item_self, index=index)
    ...
    operation_pool = [
        ...
        {"element_data": ElementsData.DivisionLeaderboardPanel.panel_myleague.btn_playercard_self, "func": panel_myleague.click_btn_playercard_self, "weight": 1},
        {"element_data": ElementsData.DivisionLeaderboardPanel.panel_myleague.item_list, "func": panel_myleague.click_item, "weight": 1},
        {"element_data": ElementsData.DivisionLeaderboardPanel.panel_myleague.item_self, "func": panel_myleague.click_item_self, "weight": 1},
        ...
        {"element_data": ElementsData.DivisionLeaderboardPanel.panel_arena.btn_playercard_self, "func": panel_arena.click_btn_playercard_self, "weight": 1},
        {"element_data": ElementsData.DivisionLeaderboardPanel.panel_arena.item_list, "func": panel_arena.click_item, "weight": 1},
        {"element_data": ElementsData.DivisionLeaderboardPanel.panel_arena.item_self, "func": panel_arena.click_item_self, "weight": 1},
        ]
