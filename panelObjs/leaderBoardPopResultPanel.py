...
class LeaderBoardPopResultPanel(BasePage):
    ...
    def get_reward_position_list(self):
        reward_position_list = self.get_position_list(element_data=ElementsData.LeaderBoardPopResult.reward_icon_list)
        return reward_position_list

    def get_reward_icon_list(self):
        reward_icon_list = self.get_icon_list(element_data=ElementsData.LeaderBoardPopResult.reward_icon_list)
        return reward_icon_list

    def get_reward_quantity_list(self):
        reward_quantity_list = self.get_text_list(element_data=ElementsData.LeaderBoardPopResult.reward_quantity_list)
