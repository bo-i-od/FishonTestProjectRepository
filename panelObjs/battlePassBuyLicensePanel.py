...
class BattlePassBuyLicensePanel(BasePage):
    ...
    def get_btn_buy_list(self):
        return self.get_position_list(element_data_list=ElementsData.BattlePassBuyLicense.btn_buy_list)

    def get_cost_icon_list(self):
        return self.get_icon_list(element_data_list=ElementsData.BattlePassBuyLicense.cost_icon_list)

    def get_cost_quantity_list(self):
        cost_quantity_list = self.get_text_list(element_data_list=ElementsData.BattlePassBuyLicense.cost_quantity_list)
